...
export function handleRefClickOpen(html: HTMLElement) {
...
export function handleDocListDropping<T>(html: HTMLElement, root_doc: LancerActor | LancerItem) {
...
export function handleLIDListDropping<T>(html: HTMLElement, root_doc: LancerActor | LancerItem) {
  // Use our handy dandy helper
...
export function handleUsesInteraction<T>(html: HTMLElement, doc: LancerActor | LancerItem) {
...
export function handleLoadedInteraction(html: HTMLElement, _doc: LancerActor | LancerItem) {
...
export function handleChargedInteraction(html: HTMLElement, _doc: LancerActor | LancerItem) {
...
export function handleRefDragging(html: HTMLElement) {
